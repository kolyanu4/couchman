...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.WindowsMenu = MainWindow.menuBar().addMenu("Windows")
        ...
        self.btn_rmserver.setObjectName("btn_rmserver")
        ...
        self.btn_editserver.setObjectName("btn_editserver")
        ...
        self.btn_dbmanager.setObjectName("btn_dbmanager")
        self.gridLayout_2.addWidget(self.btn_dbmanager, 0, 3, 1, 1)
        self.btn_workers_list = QtGui.QToolButton(self.layoutWidget)
        self.btn_workers_list.setFixedSize(340,25)
        self.btn_workers_list.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.btn_workers_list.setObjectName("btn_workers_list")
        self.gridLayout_2.addWidget(self.btn_workers_list, 1, 0, 4, 4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_workers_list.setToolTip(QtGui.QApplication.translate("MainWindow", "Workers List", None, QtGui.QApplication.UnicodeUTF8))
        self.btn_workers_list.setText(QtGui.QApplication.translate("MainWindow", "Workers List", None, QtGui.QApplication.UnicodeUTF8))
